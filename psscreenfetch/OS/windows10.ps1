...
${s}[${r}m   IIIIIIIII${s} ${s}[${g}m ==================${s} ${s}[${r}m   Uptime:${s}[0m $($OS.Uptime)m
${s}[${r}mIIIIIIIIIIII${s} ${s}[${g}m ==================${s} ${s}[${r}m   Shell:${s}[0m PowerShell $($PSVersionTable.PSVersion)
${s}[${r}mIIIIIIIIIIII${s} ${s}[${g}m ==================${s} ${s}[${r}m   CPU:${s}[0m $($OS.CPUInfo)
${s}[${r}mIIIIIIIIIIII${s} ${s}[${g}m ==================${s} ${s}[${r}m   RAM:${s}[0m $($OS.RAMFree)MiB / $($OS.RAMTotal)MiB
