...
Properties {
    ...
    Properties {
        $script = "$PSScriptRoot\psscreenfetch\psscreenfetch.psm1"
    ...
    Task Init {
        ...
        $null = New-Item ENV:BHModuleFullName -Value (Get-Item $ENV:BHProjectPath\psscreenfetch\*.psm1).FullName -Force #Needed for ScriptAnalyzer
        Get-Item ENV:BH*
